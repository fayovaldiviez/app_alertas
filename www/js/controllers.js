...
*/
    ...
    $scope.recoverKey = function(email) {
        ...
        var link = 'http://appcuautitlanseguro.gobernet.mx/appapis/KeyRecover.php';
            ...
            Auth.$signInWithEmailAndPassword(user.email, user.password)
                .then(function(authData) {
                    ...
                    push.register(function(token) {
                        ...
                        var link = 'http://appcuautitlanseguro.gobernet.mx/appapis/apinotificacionesupdate.php';
               ...
               // $scope.loggedInUser = null;
                ...
                $cordovaGeolocation
                    ...
                    .then(function(position) {
                        ...
                        //var link = "http://appcuautitlanseguro.gobernet.mx/appapis/apialertas.php?dato=";
                        var link = "http://appcuautitlanseguro.gobernet.mx/appapis/apialertas.php?dato=";
 ...
 * [CONTROLLER] ACCOUNT
 *********************************/
app.controller('AccountCtrl', function(Firebase, Auth, ionicp, $scope, $location, $http, $localStorage, $state, $ionicHistory,$rootScope,$ionicSideMenuDelegate) {
   ...
   // $scope.email = $localStorage.email;
    ...
    $scope.logout = function() {
        ...
        var link = 'http://appcuautitlanseguro.gobernet.mx/appapis/apinotificacionesnull.php';
...
app.controller('AppCtrl', function($scope, $http, Push, $localStorage, $ionicPopup,$state,$location,$timeout,$ionicModal, Auth, $ionicHistory,$rootScope) {
...
//registro de usuario directamente en firebase 
     $scope.submit = function() {

    $localStorage.nombre = $scope.data.nombre;
        if ($scope.isIncorrectValue($scope.data.email) || $scope.isIncorrectValue($scope.data.password)) {
            $scope.error = "Datos incorrectos!";
            ...
            Auth.$createUserWithEmailAndPassword($scope.data.email, $scope.data.password)
                .then(function() {
                  ...
                  // alert("usuario registrado");
                   ...
                   // return Auth.$signInWithEmailAndPassword($scope.data.email, $scope.data.pasword)

                    //se inicia session automaticamente 
        ...
        var link = 'http://appcuautitlanseguro.gobernet.mx/appapis/apiregistros.php';
...
//$scope.modalRegister.hide();
                  ...
                  //  $ionicHistory.nextViewOptions({ disableBack: true });
                   ...
                   // $state.go('menu.sms');
                    ...
                    //$state.go('menu.sms');
                    //})
//falta lo de registrar para la pus notification! 
//e insertar despues una funcion que cree el usuario mediante una llamada a una api php 
//para generar el registro mysql
//el usuario se creara directamente en la tabla usuarios
                   ...
                   // alert(" error " + error);
                    ...
                    if(error['code'] == "auth/email-already-in-use"){
                           var alertPopup = $ionicPopup.alert({
                                title: 'Error',
                                template: '¡Este correo ya se encuentra registrado!'
                            });
                    }
                   if(error['code'] == "auth/weak-password"){
                          var alertPopup = $ionicPopup.alert({
                                title: 'Error',
                                template: '¡La contraseña debe tener al menos 6 caracteres!'
                            });
...
// fin de registro de usuario directamente en firebase
...
$scope.deleteFoto = function (){
	//alert($scope.foto);
	  var link = 'http://appcuautitlanseguro.gobernet.mx/appapis/deletef.php';
   ...
   $cordovaGeolocation
                    ...
                    .then(function(position) { 
                           ...
                           // $localStorage.latitudeL = lat;
                            ...
                            var link = 'http://appcuautitlanseguro.gobernet.mx/appapis/resp.php';
      ...
      var options = {
        ...
        $cordovaCamera.getPicture(options).then(function(imageData) {
            ...
            function onSuccess(imageData) {
                ...
                var url = "http://appcuautitlanseguro.gobernet.mx/appapis/upload.php";
...
var userInfo = $localStorage.email;
  ...
  var link = 'http://appcuautitlanseguro.gobernet.mx/appapis/actualizaEstatusAlerta.php';
...
scroller.scrollTop = scroller.scrollHeight;
    ...
    var VcaptureSuccess = function(s) {
        ...
        $cordovaFileTransfer.upload(url, targetPath, options).then(function(result) {
            ...
            // alert("datos cargados correctamente");
            //carga de datos en firebase
            var urlvideo = "http://appcuautitlanseguro.gobernet.mx/files/uploads/" + s[0].name;
            $scope.uploadProgress = 0;
            database.push({
                tipoalerta: talerta,
                usuario: userInfo,
...
app.controller('controllerGrupos', function(Firebase, Auth, $scope, $location, $sce, ionicp, $http, $cordovaGeolocation, $state) {
    ...
    /*
        var link = 'http://appcuautitlanseguro.gobernet.mx/appapis/getInvitations.php';
...
app.controller('creargrupoController', function(Firebase, Auth, StorageGrupal, $scope, $location, $sce, ionicp, $http, $cordovaGeolocation, $state) {
    /*
        ...
        $scope.enviarInvitacion = function() {
            ...
            var link = 'http://appcuautitlanseguro.gobernet.mx/appapis/generarInvitacion.php';
...
*/
  ...
  var options = {
        ...
        // if ($localStorage.nombre == undefined) {
            ...
            var contactos = []; 
        var posOptions = { enableHighAccuracy: true, timeout: 20000, maximumAge: 0 };
        var link = 'http://appcuautitlanseguro.gobernet.mx/appapis/getNombre.php';
        $http.post(link, { email: $localStorage.email }).then(function(res) {
...
app.controller('TestController', function($http, $scope, StorageService, MapService, $cordovaSms, $localStorage, $cordovaGeolocation, $location) {
    ...
    $scope.testGPS = function() {
               ...
               miUbicacion.lat = position.coords.latitude;
                ...
                var key = "AIzaSyDqmVODYd0ovT31k0ya4G2RIAq_ok0NYSQ";
